...
<div class="<?php echo $recordType; ?> record" style="<?php echo $background; ?>">
    ...
    <?php if ($recordType == 'exhibit'): ?>
        ...
        <h3 id="slick-slide0<?php echo $slideCount; ?>"><?php echo link_to_exhibit(); ?></h3>
    <?php else: ?>
        <h3 id="slick-slide0<?php echo $slideCount; ?>"><?php echo link_to($featuredRecord, 'show', metadata($featuredRecord, 'display_title')); ?></h3>
