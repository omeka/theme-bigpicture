    ...
    <div class="uk-flex-row">
      <div uk-grid class="uk-grid uk-child-width-1-2 ">
          ...
          <div class="uk-padding">
            ...
            <section id="trigger-on-earth" class="uk-margin-top">
              ...
              <blockquote data-aos="fade-in">
               The crew of Apollo 15 was now embarking on the next phase – the first extended scientific exploration of the Moon -- NASA was to term our mission “the most complex and carefully planned expeditions in the history of exploration.” (Scott, 2011:p.1)  </blockquote>
              </p>
              <p data-aos="fade-in">
              ...
              <blockquote data-aos="fade-in">
              A NASA contingent of six visited the Antarctica from the 9th through the 15th of January [1970] for the purpose of assessing environmental conditions and observing scientific investigations in progress under the  United States Antarctic Research Program (USARP). (Scott, 1970:p.8) </blockquote>
              <div class="margin-v2">
              ...
              <p data-aos="fade-in">
                ...
                physical exam by the mission doctors.
              </p>
              <p data-aos="fade-in">
                Scott, Worden, and Irwin were helped into their spacesuits several hours before the launch. They had to
                wait for NASA technicians to finish the final check of the launch vehicle while wearing their spacesuits,
                which took the whole morning of that day. Finally, the three crew members entered the CSM. After the crew had entered the CSM a new round of checks followed.
              </p>
              <p data-aos="fade-in">
              ...
              <p data-aos="fade-in">
                ...
                different abort procedures that Commander Scott would need to initiate if the crew ran into unresolvable trouble (NASA, 1971e:p.7).
              </p>
              ...
              <p data-aos="fade-in">
                ...
                patches where the cue cards where placed inside the LM and the CSM (NASA, 1971n).
              </p>
              <div class="margin-v2" data-aos="fade-in">
                <figcaption class="uk-flex uk-flex-bottom uk-flex-between uk-margin-small-bottom">
                  <div class="object-title">View of the Lunar Module (LM) Panels (NASA, 1971n) </div>
              ...
              <p data-aos="fade-in">
                ...
                of the Moon (NASA, 1971c) and on the next page we see actual photos of the area around the crater from the same Lunar Landmark Maps book (NASA, 1971d).
              </p>
              <div class="margin-v2" data-aos="fade-in">
                <figcaption class="uk-flex uk-flex-bottom uk-flex-between uk-margin-small-bottom">
            ...
            <section id="trigger3">
              ...
              <h2 data-aos="fade-in" uk-sticky="offset: 80;" uk-sticky-below class="uk-margin-remove uk-ap-heading">
                Return to Earth</h2>
              <p data-aos="fade-in">
                On August 5, while the CSM was on its way back to Earth, Alfred Worden had to
                perform a deep space extravehicular activity - “the first ever performed in deep space” (Scott & Leonov, 2004:p.227).
              </p>
              <p data-aos="fade-in">
        ...
        <div class="svg-collection">
          ...
          <svg id="field" class="flight-path show" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 391.9 699" style="enable-background:new 0 0 391.9 699;" xml:space="preserve">
            <g id="Layer_2_1_">
              <image class="earth" width="300" height="300" xlink:href="/themes/bigpicture/images/FFD102E96880695B.png">
              </image>
              <image class="moon" width="300" height="300" xlink:href="/themes/bigpicture/images/FFD102E968806959.png">
              </image>
                        <path id="leg-4" style="stroke-linecap: round; stroke-linejoin: round; stroke-dasharray: 515.295px; opacity: 1; stroke-dashoffset: 1px;" fill="none" stroke="darkgrey" stroke-width="5" class="st0" d="M146.8,486.9c-12-6.3-20.3-18.1-22.2-31.5c-0.4-2.9-0.8-8.6,3.4-23.1
		...
		c-3.2-9.7-6.9-20.5-15.8-32c-5.1-6.5-10.8-13.9-21.2-18.2c-10.7-4.5-27.5-6-33.2,2.2c-1.3,1.9-2,4.2-2,6.5"></path>
              <path id="leg-3" style="stroke-linecap: round; stroke-linejoin: round; stroke-dasharray: 375.4px; opacity: 1; stroke-dashoffset: 1px;" fill="none" stroke="darkgrey" stroke-width="5" class="st0" d="M177.7,449.3c-4.3-3.7-10.1-9.6-13.3-16.8c-0.9-2.1-1.6-4.2-0.8-6.3c1.4-3.5,6-4.5,7.2-4.8
		...
		c6.9,1.4,11.4,4.9,14.9,7.8c4.6,3.7,14.3,11.6,16.2,24.7c2.3,15.8-8.2,27.4-11,30.5c-12.3,13.8-32.4,17.5-48.8,9.1"></path>
              <path id="leg-2" class="st1" style="stroke-linecap: round; stroke-linejoin: round; stroke-dasharray: 332.514px; opacity: 0.3; stroke-dashoffset: 1px;" fill="none" stroke="lightgrey" stroke-width="5" d="M118.6,414.1c0.2-1.4,0.5-2.8,0.8-4.2c1.3-5.2,3.5-10.1,6.7-14.4c2.3-3.2,5.1-5.9,8.3-8
		...
		c3.7,0.1,7.3,1.6,10,4.1c3.4,3.3,4.5,7.3,5.8,12.7c0.7,2.7,1.1,5.4,1.2,8.1"></path>
              <path id="leg-1" class="st1" style="stroke-linecap: round; stroke-linejoin: round; stroke-dasharray: 1031.97px; opacity: 0.3; stroke-dashoffset: 1px;" fill="none" stroke="lightgrey" stroke-width="5" d="M205.2,167c-0.7,2.7-1.6,6.5-2.3,11c-1.2,8-1,13.8-0.7,22.3c0.6,15.1,2.4,19.2,3.7,21.7
